      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-6 text-[#a1a1aa]">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-[#fafafa]">1. Information We Collect</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-[#fafafa]">2. How We Use Your Information</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-[#fafafa]">6. Your Rights</h2>
